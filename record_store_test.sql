...
COPY public.albums (id, name, release_year, price) FROM stdin;
229	Foo	1999	5
\.
...
SELECT pg_catalog.setval('public.albums_id_seq', 229, true);
...
SELECT pg_catalog.setval('public.artists_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.songs_id_seq', 160, true);
